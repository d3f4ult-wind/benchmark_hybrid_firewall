#!/usr/bin/env bash
# =============================================================================
# run_experiment_1b.sh — Kịch bản 1b (Slow Loris)
# Orchestrate 3 phase tự động: baseline → no_feedback → full_stack
...
ATTACKER_PID_FILE="/tmp/slowloris_attacker.pid"
...
print_summary() {
    ...
    echo ""
    echo "============================================================"
    echo " TÓM TẮT KẾT QUẢ — Kịch bản 1b (Slow Loris)"
    echo "============================================================"
    python3 << EOF
import csv, sys
...
# ─────────────────────────────────────────
echo "============================================================"
echo " run_experiment_1b.sh — Kịch bản Slow Loris"
echo " $(date)"
echo "============================================================"

# Tạo thư mục kết quả
mkdir -p "$RESULTS_DIR"
CSV_OUTPUT="$RESULTS_DIR/exp_1b_$(date +%Y%m%d_%H%M%S).csv"
